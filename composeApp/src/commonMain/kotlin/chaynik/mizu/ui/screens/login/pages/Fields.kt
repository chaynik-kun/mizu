...
import mizu.composeapp.generated.resources.option_account_navidrome_instance
import mizu.composeapp.generated.resources.option_account_password
import mizu.composeapp.generated.resources.option_account_username
import mizu.composeapp.generated.resources.option_allow_insecure_http
import mizu.composeapp.generated.resources.subtitle_allow_insecure_http
...
fun LoginScreenFields(
	...
	Row(
		modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp)
			.clickable(enabled = !isBusy) { onAllowInsecureHttpChange(!allowInsecureHttp) },
		...
		Column {
			Text(stringResource(Res.string.option_allow_insecure_http))
			Text(
				stringResource(Res.string.subtitle_allow_insecure_http),
