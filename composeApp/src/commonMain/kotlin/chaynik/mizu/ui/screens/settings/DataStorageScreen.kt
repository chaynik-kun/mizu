...
import mizu.composeapp.generated.resources.action_clear_downloads
import mizu.composeapp.generated.resources.action_clear_image_cache
import mizu.composeapp.generated.resources.action_clear_playback_cache
import mizu.composeapp.generated.resources.action_clear_pending_actions
import mizu.composeapp.generated.resources.action_rebuild_database
import mizu.composeapp.generated.resources.action_trigger_sync
import mizu.composeapp.generated.resources.count_songs
import mizu.composeapp.generated.resources.info_library_download
import mizu.composeapp.generated.resources.info_library_download_warning
import mizu.composeapp.generated.resources.info_not_available_offline
import mizu.composeapp.generated.resources.info_progress
import mizu.composeapp.generated.resources.info_status_calculating
import mizu.composeapp.generated.resources.info_status_downloading
import mizu.composeapp.generated.resources.info_sync_date_format
import mizu.composeapp.generated.resources.info_sync_hours_ago
import mizu.composeapp.generated.resources.info_sync_just_now
import mizu.composeapp.generated.resources.info_sync_mins_ago
import mizu.composeapp.generated.resources.info_sync_never
import mizu.composeapp.generated.resources.option_cover_art_quality
import mizu.composeapp.generated.resources.option_downloaded_songs
import mizu.composeapp.generated.resources.option_image_cache_size
import mizu.composeapp.generated.resources.option_automatic_playback_cache
import mizu.composeapp.generated.resources.option_playback_cache_size
import mizu.composeapp.generated.resources.subtitle_automatic_playback_cache
import mizu.composeapp.generated.resources.option_last_sync
import mizu.composeapp.generated.resources.option_live_status
import mizu.composeapp.generated.resources.option_offline_mode
import mizu.composeapp.generated.resources.option_pending_actions
import mizu.composeapp.generated.resources.subtitle_offline_mode
import mizu.composeapp.generated.resources.subtitle_pending_actions
import mizu.composeapp.generated.resources.subtitle_rebuild_database
import mizu.composeapp.generated.resources.subtitle_trigger_sync
import mizu.composeapp.generated.resources.title_cache_management
import mizu.composeapp.generated.resources.title_danger_zone
import mizu.composeapp.generated.resources.title_data_storage
import mizu.composeapp.generated.resources.title_download_quality
import mizu.composeapp.generated.resources.title_library_download
import mizu.composeapp.generated.resources.title_network
import mizu.composeapp.generated.resources.title_sync_control
...
import chaynik.mizu.ui.components.dialogs.BulkDownloadDialog
...
import mizu.composeapp.generated.resources.subtitle_download_quality
...
fun SettingsDataStorageScreen() {
	...
	val connectivityManager = koinInject<chaynik.mizu.domain.manager.ConnectivityManager>()
	...
	val playbackCacheSize by viewModel.playbackCacheSize.collectAsStateWithLifecycle(0L)
	...
	val confirmedOffline = chaynik.mizu.domain.models.connectionDisplayState(networkState, serverState) == chaynik.mizu.domain.models.ConnectionDisplayState.OFFLINE
	...
	val offlineModifier = Modifier.alpha(if (confirmedOffline) 0.75f else 1f)
	...
	Scaffold(
		...
		CompositionLocalProvider(LocalMinimumInteractiveComponentSize provides 0.dp) {
			Column(
				...
				Form {
					SettingSwitchRow(
						title = { Text(stringResource(Res.string.option_automatic_playback_cache)) },
						subtitle = { Text(stringResource(Res.string.subtitle_automatic_playback_cache)) },
						value = preferenceManager.automaticPlaybackCache,
						onSetValue = { preferenceManager.automaticPlaybackCache = it }
					)

					FormRow {
						Column(Modifier.weight(1f)) {
							Text(stringResource(Res.string.option_playback_cache_size))
							Text(
								playbackCacheSize.toStorageSize(),
								style = MaterialTheme.typography.bodyMedium,
								color = MaterialTheme.colorScheme.onSurfaceVariant
							)
						}
				...
				Form {
					FormRow(onClick = viewModel::clearPlaybackCache) {
						Text(
							stringResource(Res.string.action_clear_playback_cache),
							color = MaterialTheme.colorScheme.error,
...
private fun Long.toStorageSize(): String {
	...
	return if (megabytes >= 1024) {
		"${((megabytes / 1024) * 100).toInt() / 100.0} GB / 2 GB"
	} else {
		"${megabytes.toInt()} MB / 2 GB"
	}
}
