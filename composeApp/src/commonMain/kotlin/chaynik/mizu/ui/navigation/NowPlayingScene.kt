...
import chaynik.mizu.util.ui.rememberColorSchemeForCurrentSong
import chaynik.mizu.util.ui.rememberScreenCornerRadius
import chaynik.mizu.ui.theme.PlaybackThemeSource
import chaynik.mizu.ui.theme.selectPlaybackThemeSource
...
class NowPlayingScene<T : Any>(
	...
	override val content = @Composable {
		...
		val coverColorScheme = rememberColorSchemeForCurrentSong(forceDark = false)
		...
		val playbackColorScheme = when (selectPlaybackThemeSource(
			preferenceManager.dynamicTheming,
			preferenceManager.nowPlayingBackgroundStyle == NowPlayingBackgroundStyle.Dynamic
		)) {
			PlaybackThemeSource.ParentMaterialYou -> parentColorScheme
			PlaybackThemeSource.Artwork -> coverColorScheme
			PlaybackThemeSource.Mizu -> null
		}
		MizuTheme(playbackColorScheme) {
			ModalBottomSheet(
