...
import chaynik.mizu.data.database.relations.AlbumWithSongs
...
interface AlbumDao {
	...
	@Transaction
	@Query("SELECT * FROM AlbumEntity ORDER BY name COLLATE NOCASE ASC LIMIT :limit OFFSET :offset")
	suspend fun getAlbumsPage(limit: Int, offset: Int): List<AlbumWithSongs>
