...
interface ArtistDao {
	...
	@Query("SELECT * FROM ArtistEntity ORDER BY name COLLATE NOCASE ASC LIMIT :limit OFFSET :offset")
	suspend fun getArtistsPage(limit: Int, offset: Int): List<ArtistEntity>
