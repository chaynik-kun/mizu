...
import chaynik.mizu.data.database.relations.PlaylistWithSongs
...
interface PlaylistDao {
	...
	@Transaction
	@Query("SELECT * FROM PlaylistEntity ORDER BY name COLLATE NOCASE ASC LIMIT :limit OFFSET :offset")
	suspend fun getPlaylistsPage(limit: Int, offset: Int): List<PlaylistWithSongs>
