...
import chaynik.mizu.domain.manager.BottomBarScrollManager
...
import chaynik.mizu.ui.components.snackbars.MizuSnackBar
import chaynik.mizu.ui.navigation.BottomSheetSceneStrategy
import chaynik.mizu.ui.navigation.NowPlayingSceneStrategy
import chaynik.mizu.ui.navigation.Screen
import chaynik.mizu.ui.screens.album.AlbumListScreen
import chaynik.mizu.ui.screens.artist.ArtistDetailScreen
import chaynik.mizu.ui.screens.artist.ArtistListScreen
import chaynik.mizu.ui.screens.collection.CollectionDetailScreen
import chaynik.mizu.ui.screens.genre.GenreDetailScreen
import chaynik.mizu.ui.screens.genre.GenreListScreen
import chaynik.mizu.ui.screens.library.LibraryScreen
import chaynik.mizu.ui.screens.library.LibraryHubScreen
import chaynik.mizu.ui.screens.library.LibraryPeopleScreen
import chaynik.mizu.ui.screens.login.LoginScreen
import chaynik.mizu.ui.screens.lyrics.LyricsScreen
import chaynik.mizu.ui.screens.nowPlaying.NowPlayingScreen
import chaynik.mizu.ui.screens.nowPlaying.PlaybackSpeedScreen
import chaynik.mizu.ui.screens.playlist.PlaylistListScreen
import chaynik.mizu.ui.screens.queue.QueueScreen
import chaynik.mizu.ui.screens.radio.RadioListScreen
import chaynik.mizu.ui.screens.search.SearchScreen
import chaynik.mizu.ui.screens.settings.BottomBarScreen
import chaynik.mizu.ui.screens.settings.FontsScreen
import chaynik.mizu.ui.screens.settings.SettingsAboutScreen
import chaynik.mizu.ui.screens.settings.SettingsAcknowledgementsScreen
import chaynik.mizu.ui.screens.settings.SettingsAppIconScreen
import chaynik.mizu.ui.screens.settings.SettingsAppearanceScreen
import chaynik.mizu.ui.screens.settings.SettingsCustomHeadersScreen
import chaynik.mizu.ui.screens.settings.SettingsDataStorageScreen
import chaynik.mizu.ui.screens.settings.SettingsDeveloperScreen
import chaynik.mizu.ui.screens.settings.SettingsDownloadQualityScreen
import chaynik.mizu.ui.screens.settings.SettingsHomeScreen
import chaynik.mizu.ui.screens.settings.SettingsLogsScreen
import chaynik.mizu.ui.screens.settings.SettingsNowPlayingScreen
import chaynik.mizu.ui.screens.settings.SettingsPlaybackScreen
import chaynik.mizu.ui.screens.settings.SettingsAndroidAutoScreen
import chaynik.mizu.ui.screens.settings.SettingsScreen
import chaynik.mizu.ui.screens.settings.SettingsStreamingQualityScreen
import chaynik.mizu.ui.screens.settings.SettingsThemesScreen
import chaynik.mizu.ui.screens.share.ShareListScreen
import chaynik.mizu.ui.screens.song.SongDetailScreen
import chaynik.mizu.ui.screens.song.SongDetailSheet
import chaynik.mizu.ui.screens.song.SongListScreen
import chaynik.mizu.ui.screens.starred.StarredScreen
import chaynik.mizu.ui.theme.MizuTheme
import chaynik.mizu.util.core.PlatformContext
import chaynik.mizu.util.core.rememberPlatformContext
import chaynik.mizu.util.ui.Material3Transitions
...
val LocalDeveloperBuild = staticCompositionLocalOf { false }
...
@Composable
fun App(developerBuild: Boolean = false) {
...
private fun entryProvider(
	...
	return androidx.navigation3.runtime.entryProvider {
		...
		entry<Screen.LibraryPeople> { key ->
			LibraryPeopleScreen(key.type)
		}
		...
		entry<Screen.Settings.Home>(metadata = detailPane("settings")) {
			SettingsHomeScreen()
		}
		...
		entry<Screen.Settings.AndroidAuto>(metadata = detailPane("settings")) {
			SettingsAndroidAutoScreen()
		}
		entry<Screen.Settings.Developer>(metadata = detailPane("settings")) {
			if (LocalDeveloperBuild.current) SettingsDeveloperScreen() else SettingsScreen()
		}
